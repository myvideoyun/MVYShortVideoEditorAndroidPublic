 ...
 */
public class StylePlaneCell extends FrameLayout {
    public View containerView;
    public ImageView imageView;
    public TextView textView;

    public StylePlaneCell(Context context) {
        super(context);
        setupView();
    }

    public StylePlaneCell(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView();
    }

    public StylePlaneCell(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setupView();
    }

    private void setupView() {
        containerView = inflate(getContext(), R.layout.style_plane_cell, this);
