...
extern "C" JNIEXPORT jstring Java_com_myvideoyun_soundtouch_SoundTouch_getVersionString(JNIEnv *env, jobject thiz)
{
    const char *verStr;
...
extern "C" JNIEXPORT jlong Java_com_myvideoyun_soundtouch_SoundTouch_newInstance(JNIEnv *env, jobject thiz)
{
    return (jlong)(new SoundTouch());
}


extern "C" JNIEXPORT void Java_com_myvideoyun_soundtouch_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz, jlong handle)
{
...
extern "C" JNIEXPORT void Java_com_myvideoyun_soundtouch_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setTempo(tempo);
}
...
extern "C" JNIEXPORT void Java_com_myvideoyun_soundtouch_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
    SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" JNIEXPORT void Java_com_myvideoyun_soundtouch_SoundTouch_setSpeed(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
    SoundTouch *ptr = (SoundTouch*)handle;
    ptr->setRate(speed);
}
...
extern "C" JNIEXPORT jstring Java_com_myvideoyun_soundtouch_SoundTouch_getErrorString(JNIEnv *env, jobject thiz)
{
...
extern "C" JNIEXPORT int Java_com_myvideoyun_soundtouch_SoundTouch_processFile(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
    SoundTouch *ptr = (SoundTouch*)handle;
